...
t.payment_type,
t.total_profit,
CONCAT(t.received+t.received2, '(', t.received, '/', t.received2,')') as 'revenue', 
t.expense AS 'cost',
it.indiv_number, 
date_format(it.depart_date, '%Y-%m-%d') AS 'depart_date', 
date_format(it.arrival_date, '%Y-%m-%d') AS 'arrival_date',
cc.code, 
sn.source_name, 
t.note, 
gc.c_list, 
