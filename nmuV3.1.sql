...
-- Wed 05 Sep 2018 05:58:44 PM EDT
...
CREATE TABLE IF NOT EXISTS `nmu`.`GroupTour` (
  ...
  INDEX `fk_wholesaler_id_gt_idx` (`wholesaler_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `nmu`.`TourDetails` (
  ...
  INDEX `fk_customer_id_idx` (`customer_id` ASC) VISIBLE,
  INDEX `fk_indiv_tour_id_idx` (`indiv_tour_id` ASC) VISIBLE,
  INDEX `fk_cc_id_idx` (`cc_id` ASC) VISIBLE,
  INDEX `it_mco_id_idx` (`mco_id` ASC) VISIBLE,
