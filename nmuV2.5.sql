...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nmu`.`Wholesaler` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nmu`.`Salesperson` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nmu`.`TouristGuide` ;
...
-- Table `nmu`.`GroupTour`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nmu`.`GroupTour` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nmu`.`CouponCode` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nmu`.`IndividualTour` ;
...
-- Table `nmu`.`Customer`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nmu`.`Customer` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nmu`.`AirticketTour` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nmu`.`CustomerSource` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nmu`.`Transactions` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `nmu`.`TourDetails` ;
